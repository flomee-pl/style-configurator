...
public interface IClothingAttributesController {
    ...
    @Operation(summary = "Get available clothing categories", description = "Retrieve a list of available clothing categories such as colors, shops, and clothing parts")
    @ApiResponses(value = {
